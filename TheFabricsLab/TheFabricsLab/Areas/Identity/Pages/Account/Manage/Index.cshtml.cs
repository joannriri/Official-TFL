...
namespace TheFabricsLab.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, AppDbContext context)
        {
        ...
        public async Task OnGetAsync()
        {
            ...
            if (user != null)
            {
                ...
                Orders = await _context.Orders
                                         ...
                                         .OrderByDescending(o => o.OrderID)  // Ordering by OrderDate (newest first)
                                         .ToListAsync();
            }
        }
